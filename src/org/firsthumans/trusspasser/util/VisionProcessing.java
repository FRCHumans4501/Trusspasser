...
public class VisionProcessing {
    ...
    final static int H_LOW = 79;
    final static int H_HIGH = 255;
    final static int S_LOW = 71;
    final static int S_HIGH = 255;
    final static int V_LOW = 113;
    final static int V_HIGH = 255;
    ...
    public void setTargetListener(VisionListener listener) {
    ...
    public void update() {
        ...
        try {
            ...
            */
            ...
            System.out.println("X Width: " + image.getWidth());
            BinaryImage thresholdImage = image.thresholdHSV(H_LOW, H_HIGH, S_LOW, S_HIGH, V_LOW, V_HIGH);   // keep only green objects
            ...
            if(filteredImage.getNumberParticles() > 0) {
                ...
                if(verticalTargetCount > 0) {
                    ...
                    if (this.listener != null) {
                        ParticleAnalysisReport verticalReport = filteredImage.getParticleAnalysisReport(verticalTargets[target.verticalIndex]);
                        ParticleAnalysisReport horizontalReport = filteredImage.getParticleAnalysisReport(horizontalTargets[target.horizontalIndex]);
                        
                        this.listener.onVisionProcessed(target.Hot,
                                (float)distance,
                                verticalReport.center_mass_x,
                                verticalReport.center_mass_y,
                                horizontalReport.center_mass_x,
                                horizontalReport.center_mass_y);
                        }
                } else {
                    if (this.listener != null) {
                        this.listener.onVisionProcessed(false, 0, 0, 0, 0, 0);
                    }
                }
            }
